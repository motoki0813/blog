...
クラス名はRunnableClass1としています。
    ![](./how-to-pipeline/CreateProject5.png)
...
この場合下記のようにWorkspaceが作成できれば大丈夫です。
    ![](./how-to-pipeline/CreateProject7.png)
...
該当のタスクが見つからない場合、Dynamics 365 Finance and Operations Toolsのインストールを確認してください。
